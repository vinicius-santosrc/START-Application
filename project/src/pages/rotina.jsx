                    ...
                    setOutput(rotina2.map(i => {
                        return(
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {JSON.stringify(i.name).replace(/"/g, '')}
                                        </td>
                                        <td>
                                            <span className="comecocomponent">{JSON.stringify(i.start).replace(/"/g, '')}</span> - <span className="fimcomponente">{JSON.stringify(i.end).replace(/"/g, '')}</span>
                                        </td>
                                        <td>
